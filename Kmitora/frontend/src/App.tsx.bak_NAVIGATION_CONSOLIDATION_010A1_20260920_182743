...
import LifecycleStageWorkspace from "./components/LifecycleStageWorkspace";
...
export default function App() {
  ...
  const page = (() => {
    switch(active) {
      case "overview": return <ControlTowerPremium />;
      ...
      case "detect": return <LifecycleStageWorkspace stageKey="detect" onNavigate={setActive}/>;
      case "diagnose": return <LifecycleStageWorkspace stageKey="diagnose" onNavigate={setActive} advancedRuntime={advancedRuntime}/>;
      case "predict": return <LifecycleStageWorkspace stageKey="predict" onNavigate={setActive} advancedRuntime={advancedRuntime}/>;
      case "recommend": return <LifecycleStageWorkspace stageKey="recommend" onNavigate={setActive} advancedRuntime={advancedRuntime}/>;
      case "simulate": return <LifecycleStageWorkspace stageKey="simulate" onNavigate={setActive} advancedRuntime={advancedRuntime}/>;
      ...
      case "agents": return <AgentOperations/>;
  ...
  return <div className="appShell">
    ...
    <A000Panel onAdvancedRuntime={setAdvancedRuntime}/>
  </div>
}
