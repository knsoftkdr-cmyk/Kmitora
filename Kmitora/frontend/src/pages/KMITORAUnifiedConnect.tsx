...
import DomainIntelligencePanel from "../components/DomainIntelligencePanel";
type Props = {
...
export default function KMITORAUnifiedConnect({
  ...
  return <div className="ku-page">
    ...
    <header className="ku-header"><div className="ku-eyebrow">KMITORA CONNECT</div><h1>Source &amp; Target Systems</h1></header>
...
<DomainIntelligencePanel />
    ...
    {requirementsOpen && <KMITORABusinessRequirementsWorkspace onClose={() => { setRequirementsOpen(false); window.setTimeout(() => window.scrollTo({ top: 0, behavior: "smooth" }), 0); }} onContinue={() => onNavigate?.("discover")} />}
  </div>;
}