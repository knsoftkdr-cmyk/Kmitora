...
Write-Host '=== KMITORA A000 LIFECYCLE QUALIFICATION 029D2 ===' -ForegroundColor Cyan
...
if ([string]::Equals($SourceFull, $TargetFull, [System.StringComparison]::OrdinalIgnoreCase)) {
    ...
    if (Test-Path -LiteralPath $Target) {
        ...
        if ($srcHash -eq $dstHash) {
            ...
            $Backup = "$Target.pre029d2_$Stamp.bak"
...
Write-Host 'A000_LIFECYCLE_QUALIFICATION_029D2 applied successfully.' -ForegroundColor Green
