...
def project_lifecycle_response(
    *,
    ...
    """Attach a read-only A000 projection to a successful lifecycle response.

    The existing response payload remains authoritative and unchanged except for
    one additive `lifecycle_runtime` field. Error responses and non-lifecycle
    routes are returned untouched.
    """
