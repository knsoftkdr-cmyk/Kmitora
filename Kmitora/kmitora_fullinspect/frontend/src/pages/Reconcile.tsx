...
export default function Reconcile() {
  ...
  useEffect(() => {
    ...
    const storedRecon =
      readStoredJson<ReconciliationResult>(
        LAST_RECONCILIATION_KEY
      );

    const storedEvidence =
      readStoredJson<EvidencePackage>(
        LAST_EVIDENCE_KEY
      );

    if (storedExecution) {
      setExecutionId(storedExecution);
    }
  ...
  async function runReconciliation() {
    ...
    if (!id) {
      setError(
        "Enter a DEV dry-run execution ID."
      );
      return;
    }
    ...
    <div className="page reconcileWorkspacePage">
      ...
      <div className="reconcileHero">
        ...
        <div className="reconcileHeroCopy">
          ...
          <p>
            Compare source data,
            simulated target results,
            mapping and transformation
            evidence from the same KMITORA
            DEV dry-run execution.
          </p>
      ...
      <section className="reconcileSection">
        ...
        <div className="panel reconcileRunPanel">
          ...
          <input
            ...
            placeholder="DEV dry-run execution ID"
          />
      ...
      <div className="reconcileSafetyNote">
        ...
        <div>
          ...
          <span>
            DRY_RUN = TRUE means target
            production writes remain 0 and
            production actions remain 0.
