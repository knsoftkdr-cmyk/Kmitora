  ...
  const recordSafeValidationInteraction = async (
    ...
    if (action === "RUN_IMPACTED_TESTS") {
      try {
        ...
        const updated =
          await runRealDevValidation(discovery);
        ...
        setValidationNotice(
          ...
          "Source writes 0. Target writes 0. Production actions remain disabled."
        );
      } catch (error) {
        setValidationNotice(
      ...
      <section className="validateSection">
        ...
        <div className="validateDomainGrid">
          ...
          <div className="validateDomainCard">
            ...
            <small>
              Execution remains NOT EXECUTED
            </small>
